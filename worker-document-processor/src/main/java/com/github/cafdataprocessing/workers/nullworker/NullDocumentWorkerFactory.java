 ...
 */
package com.github.cafdataprocessing.workers.nullworker;
...
public enum NullDocumentWorkerFactory implements DocumentWorkerFactory
{
    INSTANCE;
    ...
    {
        return NullDocumentWorker.INSTANCE;
    }
}
