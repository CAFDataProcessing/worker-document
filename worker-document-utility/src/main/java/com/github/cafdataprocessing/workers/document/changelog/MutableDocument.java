 ...
 */
package com.github.cafdataprocessing.workers.document.changelog;

import com.github.cafdataprocessing.workers.document.DocumentWorkerChange;
import com.github.cafdataprocessing.workers.document.DocumentWorkerChangeLogEntry;
...
import com.github.cafdataprocessing.workers.document.exceptions.InvalidChangeLogException;
import com.github.cafdataprocessing.workers.document.exceptions.UnexpectedSubdocumentReferenceException;
import com.github.cafdataprocessing.workers.document.views.ReadOnlyDocument;
import com.github.cafdataprocessing.workers.document.views.ReadOnlyFailures;
import com.github.cafdataprocessing.workers.document.views.ReadOnlyFieldValue;
import com.github.cafdataprocessing.workers.document.views.ReadOnlyFailure;
import com.github.cafdataprocessing.workers.document.views.ReadOnlyFieldValues;
...
public final class MutableDocument
{
    ...
    private void applyChange(final DocumentWorkerChange change) throws InvalidChangeLogException
    {
        ...
        final DocumentWorkerChange.SetReferenceParams setReferenceParams = change.setReference;
        ...
        final DocumentWorkerChange.InsertSubdocumentParams insertSubdocumentParams = change.insertSubdocument;
        if (insertSubdocumentParams != null) {
            insertSubdocument(insertSubdocumentParams.index,
                              insertSubdocumentParams.subdocument);
        }

        final DocumentWorkerChange.UpdateSubdocumentParams updateSubdocumentParams = change.updateSubdocument;
        ...
        final DocumentWorkerChange.RemoveSubdocumentParams removeSubdocumentParams = change.removeSubdocument;
