...
{
    private final ServiceProvider taskServiceProvider;
    ...
    {
        super(application);
        this.taskServiceProvider = Objects.requireNonNull(taskServiceProvider);
    ...
    {
        return taskServiceProvider.getService(service);
    }
    ...
    @Nonnull
    public final TaskResult createWorkerResponse()
    {
        return createWorkerResponseImpl();
    }

    @Nonnull
    protected abstract TaskResult createWorkerResponseImpl();
