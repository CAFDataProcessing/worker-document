 ...
 */
package com.github.cafdataprocessing.workers.document.model;
...
public interface Field extends DocumentWorkerObject
{
     ...
     * To replace existing values by a new one use {@link #set(java.lang.String)}. The value will be stored using the UTF-8 encoding.
     *
    ...
    /**
     * Adds the specified binary blob value to this field. To replace existing values by a new one use {@link #set(byte[])}.
     *
     ...
     * To replace existing values by a new one use {@link #setReference(java.lang.String)}. The Worker Framework has the concept of a
     ...
     * Removes existing values by {@link #clear()} and adds new one by {@link #addReference(java.lang.String)}. The Worker Framework has
