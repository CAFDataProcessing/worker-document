 ...
 */
package com.github.cafdataprocessing.workers.testworker;
...
public final class TestWorker implements DocumentWorker
{
    @Override
    ...
    {
        document.getField("NEW_FIELD").set("new_value");
    }
}
